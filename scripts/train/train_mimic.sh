FINETUNE_DATA_PATH="/data/annotations/mimic-cxr-jpg/mimic_reports_all_images.json" #finetune annotation file path
FINETUNE_IMAGE_PATH="/data/mount/mimic-cxr-jpg-2.1.0.physionet.org" #finetune image dir
